...
engine = create_engine('postgresql://todoapi:todoapi@localhostL5432/postgres')
meta_data = MetaData(schema = 'todo_tables', bind = engine)
...
class Todo(Base, PrimaryKeyIdMixin):
	...
	user = relationship('User', back_populates = 'todos') # does not exists in db
